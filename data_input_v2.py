...
# model.add(layers.Conv2D(100, (3,3), activation=parameter_3, input_shape=(axial_len,circ_len,1)))
# model.add(layers.MaxPooling2D((2,2)))
# model.add(layers.Conv2D(200, (3,3), activation=parameter_4))
# model.add(layers.MaxPooling2D((2,2)))
# model.add(layers.Conv2D(200, (3,3), activation=parameter_5))
